...
public class Program
{
    public static void Main(string[] args)
    {
      ...
      builder.Services.AddSingleton(x => new DatabaseManager(connectionString));
        ...
        {
            // The default HSTS value is 30 days. You may want to change this foutePatternException: There is an incomplete parameter in the route template. Check that each '{' character has a matching '}' character.or production scenarios, see https://aka.ms/aspnetcore-hsts.
            app.UseHsts();
        }
